...
import com.my.rpc.data.remote.ApiResponse
import com.my.rpc.data.remote.ExternalAsset
import com.my.rpc.data.remote.ImgurResponse
...
fun Context.shareFile(file: File?) {
    if (file == null) return
    val uri = FileProvider.getUriForFile(this, "com.my.rpc.provider", file)
